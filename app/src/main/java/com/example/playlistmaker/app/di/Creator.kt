...
import com.example.playlistmaker.domain.usecase.GetThemeStatusUseCaseImpl
...
object Creator {
    ...
    fun provideSettingsViewModel(context: Context): SettingsViewModel {
        ...
        val getThemeStatusUseCase: GetThemeStatusUseCase =
            GetThemeStatusUseCaseImpl(themeRepository)

        val switchThemeUseCase: SwitchThemeUseCase =
            SwitchThemeUseCaseImpl(themeRepository)
